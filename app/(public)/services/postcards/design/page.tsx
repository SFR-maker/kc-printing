...
export const metadata: Metadata = {
  title: "Design Your Postcard Online",
  description: "Choose from professionally designed postcard templates or start from a blank canvas. Customize every detail and get a print-ready file in minutes.",
};
  ...
  return (
    <div className="section-pad container-tight">
      <div className="mb-10 text-center">
        ...
        <h1 className="mb-4 text-4xl font-black tracking-tight text-kc-dark sm:text-5xl">Design Your Postcard</h1>
      ...
      <TemplateGallery product="postcard" />
    </div>
  );
}
