...
export const metadata: Metadata = {
  ...
  description:
    "Custom business cards, postcards, banners, rigid signs, and window decals designed by a real designer and delivered print-ready. Fast online ordering. Serving Kansas City, Johnson County, Dallas-Fort Worth, and nationwide.",
