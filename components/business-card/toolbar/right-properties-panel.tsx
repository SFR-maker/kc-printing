...
export function RightPropertiesPanel() {
  ...
  if (selected.length === 0) {
    return (
      <div className="flex w-64 shrink-0 items-center justify-center border-l border-kc-border bg-white p-6 text-center text-sm text-kc-muted">
  ...
  return (
    <div className="flex w-64 shrink-0 flex-col gap-4 overflow-y-auto border-l border-kc-border bg-white p-4">
