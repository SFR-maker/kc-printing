          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                href={link.href}
                className={cn(
                  "relative py-1 text-[13.5px] font-medium tracking-tight transition-colors hover:text-kc-magenta-deep",
      ...
      {open && (
        ...
        >
          ...
          <div className="mt-4 flex flex-col gap-2">
            <a
              href="tel:+18165210462"
              className="flex items-center gap-2 py-1 font-mono text-[13px] text-kc-dark/60"
            >
